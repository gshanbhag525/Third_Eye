...
class Third_Eye_I2C(object):
  ...
  def getPiI2CBusNumber():
    ...
    return 1 if Third_Eye_I2C.getPiRevision() == 2 else 1

  @staticmethod
  def getPiI2CBusNumber2():
    # get I2C bus number from /proc/cpuinfo*
    revision = Third_Eye_I2C.getPiRevision_2()
    if revision in [2, 3]:
      return 1 
  ...
  def __init__(self, address, busnum=-1, debug=False):
    ...
    self.bus = smbus.SMBus(busnum if busnum >= 0 else Third_Eye_I2C.getPiRevision_2())
    self.debug = debug
